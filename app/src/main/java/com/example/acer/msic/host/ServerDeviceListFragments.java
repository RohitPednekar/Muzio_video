 ...
 */
public class ServerDeviceListFragments extends ListFragment implements
		PeerListListener, ConnectionInfoListener, Handler.Callback
{
	...
	public void onListItemClick(ListView l, View v, int position, long id)
	{
		...
		switch (device.status)
		{
			case WifiP2pDevice.AVAILABLE:
				...
				((HostFragmentListener) getActivity()).connect(config);
				break;
			...
			case WifiP2pDevice.INVITED:
				...
				((HostFragmentListener) getActivity()).cancelDisconnect();
				// start another discovery
				((HostFragmentListener) getActivity()).discoverDevices();
				break;
			...
			case WifiP2pDevice.CONNECTED:
				...
				((HostFragmentListener) getActivity()).disconnect();
				// start another discovery
				((HostFragmentListener) getActivity()).discoverDevices();
				break;
		...
		((HostFragmentListener) getActivity()).showDetails(device);
	}
	...
	public void onConnectionInfoAvailable(WifiP2pInfo info)
	{
		...
		((HostFragmentListener) getActivity()).showInfo(info);
	 ...
	 * events.
	 */
	public interface HostFragmentListener
	{
